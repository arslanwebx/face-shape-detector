...
export default function BlogArchive() {
  ...
  return (
    <section className="blog-library" aria-labelledby="all-articles-heading">
      ...
      <div className="library-heading"><div><p className="eyebrow">Complete library</p><h2 id="all-articles-heading">All face-shape articles</h2></div><p>{blogArticles.length} practical guides and comparisons</p></div>
